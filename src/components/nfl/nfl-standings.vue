                    ...
                    <tbody>
                        <tr>
                            <th scope="row" colspan="2">
                                <img
                                    :src="afc[n - 1].value[i - 1].team.logo"
                            ...
                            <td>
                                {{ afc[n - 1].value[i - 1].records.division }}
                            </td>
                ...
                <template v-for="i in 4">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row" colspan="2">
                                <img
                                    :src="nfc[n - 1].value[i - 1].team.logo"
                            ...
                            <td>
                                {{ nfc[n - 1].value[i - 1].records.division }}
                            </td>
